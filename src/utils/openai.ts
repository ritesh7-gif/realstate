...
export async function fetchOpenAIChat(message: string, history: any[]) {
  ...
  const apiKey = (import.meta as any).env?.VITE_OPENAI_API_KEY || atob("c2stcHJvai02VWF2d0lubHdTaGJoblhwWGpWWWFvTHlucnVUd3U1RzVOcG4tUmdKX3FKeFpKNy1na295d0FNeV81NG4waTN5NWZCTTltY25rUFQzQmxia0ZKZFNIYndLZktZLXBqc19PZmlOdWNMT043ZzZkaktjdnloWnY5STVWM2I3V2hOUmdRRmZ1RmRiMDlsQjdtWGNmSXJsZWd5V0o5Z0E=");
